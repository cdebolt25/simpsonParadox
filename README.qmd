...
- **Within each species (colored lines):** Negative relationship - longer bills are shallower!
...
comparison_plot <- (plot1 | plot2) +
  plot_annotation(
    ...
    subtitle = "Same data, opposite relationships when considering species grouping",
    caption = "Left: Overall positive correlation | Right: Negative correlation within species\n\nConfounding variables can reverse apparent trends",
    theme = theme(
      ...
      plot.caption = element_text(size = 9, hjust = 0, face = "italic", 
                                 margin = margin(t = 15), lineheight = 1.4)
    )
  )
...
- **Left plot:** Shows the misleading overall trend (positive correlation)
- **Right plot:** Reveals the true relationship within each species (negative correlation)
- **The paradox:** Same data tells two different stories depending on species grouping
