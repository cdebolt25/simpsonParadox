...
comparison_plot <- (plot1 | plot2) +
  plot_annotation(
    ...
    theme = theme(
      plot.title = element_text(size = 14, face = "bold", hjust = 1.8),
      plot.subtitle = element_text(size = 7, hjust = 0.5, margin = margin(b = 20)),
...
- **The paradox:** The same data tells two completely different stories depending on whether we consider the species grouping variable
